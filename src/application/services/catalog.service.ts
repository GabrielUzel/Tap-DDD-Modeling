import type { CreateCatalogInput, CreateCatalogOutput } from "../dtos/catalog/create-catalog.dto";
import { Uuid } from "../../shared/uuid";
import { Catalog } from "../../domain/entities/catalog.entity";
import { CatalogType, type CatalogTypeOptions } from "../../domain/value-objects/catalog-type.value";
...
export class CatalogService {
  ...
  public async createCatalog(
    ...
    try {
      const catalogType = new CatalogType(input.catalogType as CatalogTypeOptions);
