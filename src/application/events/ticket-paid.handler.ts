...
import { RegisterSaleCommand } from "../commands/dtos/register-sale.command";
import { Uuid } from "src/domain/@shared/interfaces/uuid";

@EventsHandler(TicketPaidEvent)
export class RegisterSaleOnTicketPaidHandler implements IEventHandler<TicketPaidEvent> {
  constructor(
